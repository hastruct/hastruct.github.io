---
title: "Neuro-Symbolic AI & Tự Động Hóa Thiết Kế Revit API: Ứng dụng cho công trình thủy lợi"
author_profile: true
author_name: "HST.AI"
...
toc_sticky: true
toc_label: "📑 Mục Lục"
permalink: "/posts/neuro-symbolic-revit-api-thuy-loi/"
categories:
  - BIM-Automation
...
excerpt: "Phân tích kiến trúc Neuro-Symbolic AI (95% Rule-Based + 5% ML) cho tự động hóa Revit API: Lõi thuật toán xác định, tầng LLM Reasoning, ứng dụng mở rộng từ HVAC sang thiết kế kênh mương, đê biển, Adaptive Component. Code C# pseudo-code, Terrain-aware Pathfinding, Self-Correction, ROI thiết kế, ứng dụng TCVN tiêu chuẩn."
header:
