...
excerpt: "> *Hướng dẫn mô phỏng mô hình Modified Cam-Clay (MCC)*: Lý thuyết mặt chảy ellipse, NCL/CSL, 7 tham số địa kỹ thuật, phân tích triaxial drained/undrained, ma trận độ cứng đàn dẻo, 4 biểu đồ toàn diện (q-εₐ, p-q, εᵥ-p, e-ln(p)), xuất CSV/PNG, ứng dụng thiết kế nền móng."
header:
