...
PMBOK — Cẩm nang Kiến thức Quản lý Dự án do Project Management Institute (PMI) xuất bản — đề xuất một cách tiếp cận khác: tích hợp quản lý tiến độ và chi phí ngay từ giai đoạn lập kế hoạch thông qua một đường cơ sở (baseline) duy nhất, và đo lường sai lệch bằng hệ thống chỉ số có thể hành động được.
...
**Xác định ngân sách:** Tổng hợp chi phí ước tính thành đường ngân sách tổng thể (cost baseline) theo thời gian — đây là đường cong S (S-curve) thường thấy trong báo cáo tiến độ. Đường S này là cơ sở duy nhất để đánh giá tiến độ giải ngân thực tế.

**Kiểm soát chi phí:** So sánh chi phí thực tế với ngân sách theo kế hoạch, kết hợp với dữ liệu tiến độ để đánh giá hiệu quả chi tiêu — không chỉ đã chi bao nhiêu, mà chi bấy nhiêu đó có đổi được khối lượng đúng kế hoạch không.
...
|-------------|-----------------|-------|
| Dưới 50 tỷ đồng, 1–2 gói thầu | Phần mềm lập lịch đơn + Excel EVM | Đủ dùng, chi phí thấp, đội ngũ nhỏ |
| 50–300 tỷ đồng, 3–8 gói thầu | Phần mềm lập lịch chuyên dụng + phần mềm chi phí nội địa + dashboard BI | Đáp ứng yêu cầu pháp lý + đủ năng lực phân tích |
| 300–1.000 tỷ đồng, nhiều gói thầu | Nền tảng tích hợp hoặc tổ hợp kết nối dữ liệu | Đủ khả năng kết hợp EVM đa gói thầu |
...
**Cấp kỹ sư công trường:** Hiểu cách đo lường và báo cáo % hoàn thành theo phương pháp đã định nghĩa. Không cần biết vận hành phần mềm, nhưng phải biết cung cấp đúng thông tin cần thiết đúng thời hạn.

**Cấp cán bộ PMU:** Vận hành phần mềm, cập nhật lịch biểu thực tế, tính toán EV và xuất báo cáo. Cần được đào tạo kỹ thuật cụ thể về phần mềm đang sử dụng và về phương pháp EVM.

**Cấp quản lý PMU và chủ đầu tư:** Đọc và diễn giải chỉ số EVM, phân biệt khi nào SPI/CPI thấp là tín hiệu cần hành động và khi nào là biến động bình thường đầu kỳ. Cần hiểu phương pháp, không nhất thiết phải biết vận hành phần mềm.
...
Vấn đề cốt lõi của quản lý tiến độ và chi phí trong dự án xây dựng Việt Nam không phải là thiếu phần mềm. Phần mềm Primavera P6 đã có mặt tại nhiều PMU từ hơn một thập kỷ; phần mềm dự toán nội địa đã được chuẩn hóa theo định mức Bộ Xây dựng. Vấn đề là hai hệ thống này không nói chuyện được với nhau để tạo ra chỉ số tích hợp có khả năng cảnh báo sớm.

PMBOK giải quyết vấn đề này không phải ở cấp độ phần mềm, mà ở cấp độ tư duy: trước khi chọn công cụ nào, cần thiết lập một đường cơ sở (baseline) tích hợp tiến độ và chi phí, một phương pháp đo lường % hoàn thành nhất quán, và một quy trình leo thang rõ ràng khi chỉ số cảnh báo xuất hiện.
...
Nếu bạn đang cân nhắc cách tổ chức hệ thống quản lý tiến độ và chi phí cho dự án đang chuẩn bị hoặc đang triển khai, bài viết [**Tư vấn quản lý dự án xây dựng: Vấn đề thực tiễn và giải pháp**](/posts/tvqlda-van-de-giai-phap/) đăng ngày 19/5/2026 phân tích bốn nhóm vấn đề cốt lõi mà đơn vị tư vấn quản lý dự án thường gặp, kèm căn cứ pháp lý theo Nghị định 175/2024/NĐ-CP và Luật Xây dựng 135/2025/QH15 — là nền tảng pháp lý để giao đúng vai trò cho TVQLDA trong việc vận hành hệ thống EVM.
