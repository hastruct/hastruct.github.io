---
title: "Trích Xuất Dữ Liệu ETABS: Parser File E2K với Excel VBA"
author_profile: true
author_name: "HST.AI"
...
toc_sticky: true
toc_label: "📑 Mục Lục"
permalink: "/posts/etabs-parser-e2k-vba/"
categories:
  - Automation
  - Structural-Analysis
  - VBA-Programming
...
excerpt: "Hướng dẫn trích xuất dữ liệu từ mô hình ETABS bằng cách đọc file .e2k trực tiếp với Excel VBA: Parser logic, các hàm GetDecimal/GetQuotedString, module Đọc-Tìm-Trích xuất, tốc độ nhanh gấp hàng chục lần so với CSI API, không cần bản quyền ETABS, ứng dụng QA/QC mô hình kết cấu."
header:
