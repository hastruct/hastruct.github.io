...
toc_sticky: true
toc_label: "Mục Lục"
permalink: "/posts/du-an-bat-dong-san/"
categories:
  - Quản lý dự án
  - Xây dựng
  - Project-Management
tags:
  ...
  - Rủi ro xây dựng
  - Chủ đầu tư
excerpt: "Dự án bất động sản không chỉ là bài toán xây dựng. Đây là bài toán tài chính, thị trường và pháp lý đan xen với nhau, trong đó tiến độ thi công thường là biến số chịu áp lực nhiều nhất từ tất cả các phía."
header:
...
Đây là tình huống điển hình của dự án bất động sản: tiến độ xây dựng không chỉ do kỹ thuật quyết định mà còn chịu ảnh hưởng từ cấu trúc tài chính, ràng buộc pháp lý, và kỳ vọng của nhiều nhóm bên liên quan với lợi ích không hoàn toàn trùng nhau.
...
Với lãi suất vay dự án bất động sản thường ở mức 10-12% mỗi năm (tính đến cuối 2025), mỗi tháng chậm tiến độ của một dự án 1.000 tỷ đồng vốn vay tương đương khoảng 9-10 tỷ đồng chi phí lãi vay phát sinh thêm. Con số này đủ để tạo áp lực trực tiếp lên Ban Giám đốc dự án trong mỗi cuộc họp.
...
## 6. Bốn vùng tài chính của nhà đầu tư bất động sản

Gita Faust, chuyên gia tài chính bất động sản người Mỹ, sau khi xem xét hàng trăm hồ sơ sổ sách của nhà đầu tư, nhận ra một mô hình lặp đi lặp lại: phần lớn nhà đầu tư đang bị kẹt trong một trong bốn vùng tài chính, và vấn đề thực sự không phải là thuế, chi phí tăng hay thiếu thương vụ, mà là hệ thống tài chính không theo kịp quy mô kinh doanh.[^5]

![Bốn vùng tài chính của nhà đầu tư bất động sản (Gita Faust)](/assets/images/posts/du-an-bat-dong-san/4-financial-zones-real-estate.jpg)
*Nguồn: Gita Faust, "The 4 Financial Zones of Real Estate Investors", LinkedIn Pulse, tháng 6/2026.*[^5]

### 6.1. Vùng 1: The Chaos Zone (Vùng Hỗn loạn)

Mọi thứ cảm giác nặng nề hơn mức đáng ra. Sổ sách tồn đọng, dữ liệu nằm rải rác giữa bảng tính, sao kê ngân hàng và phần mềm kế toán nhưng không có cấu trúc thực sự. Chi tiêu cá nhân và doanh nghiệp nhiều khi vẫn lẫn lộn. Quyết định được đưa ra chủ yếu dựa trên số dư tài khoản, không phải từ báo cáo.

Faust nhận xét thẳng: *"Vấn đề ở đây không chỉ là sổ sách lộn xộn, mà là chưa có nền tảng tài chính đủ vững để chống đỡ cho kinh doanh."*

Trong bối cảnh dự án xây dựng tại Việt Nam, đây là tình trạng chủ đầu tư không có hệ thống kiểm soát chi phí nội bộ, không theo dõi dòng tiền theo từng giai đoạn, và ban giám đốc ra quyết định bằng ước tính thay vì số liệu thực.

### 6.2. Vùng 2: The DIY Drag (Vùng Tự Xoay Sở)

Nhiều nhà đầu tư mắc kẹt ở đây lâu hơn cần thiết. Họ đang dùng phần mềm kế toán, đang cố gắng, thậm chí có báo cáo, nhưng hệ thống không được thiết kế cho bất động sản, nên các con số không thực sự giúp vận hành. Thời gian vẫn hao tổn vào sửa lỗi, truy tìm câu trả lời, và toàn bộ bộ máy vẫn phụ thuộc vào trí nhớ của một người.

Tương đương trong quản lý dự án xây dựng: PM dùng file Excel nhiều tab thay vì hệ thống tích hợp. Chạy được lúc đầu, nhưng khi dự án mở rộng thì sai lệch tích tụ, và không ai biết lỗi phát sinh từ đâu.

### 6.3. Vùng 3: The System Gap (Vùng Khoảng Trống Hệ Thống)

Sổ sách trông tốt hơn, nhưng doanh nghiệp vẫn không cảm thấy được hỗ trợ đầy đủ. Có thể đã có kế toán hỗ trợ, báo cáo đến hàng tháng, nhưng chúng vẫn không cho thấy bức tranh toàn cảnh: dòng tiền từng bất động sản, quỹ dự phòng, nợ vay, chi phí vận hành, hiệu suất thực.

Faust mô tả vấn đề cốt lõi: *"Số liệu cho bạn biết điều gì đã xảy ra. Chúng không giúp bạn quản lý điều sẽ xảy ra tiếp theo."*

Đây là lúc cần kiểm soát chặt hơn, báo cáo rõ hơn, quy trình tài chính tốt hơn, không chỉ để chính xác, mà để vận hành trơn tru và ra quyết định kịp thời.

### 6.4. Vùng 4: The Confidence Zone (Vùng Tự Tin)

Tới đây, số liệu bắt đầu làm việc cho bạn thay vì chống lại bạn. Sổ sách sạch, cập nhật. Báo cáo được cấu trúc đúng cho ngành bất động sản. Bạn nhìn thấy tình trạng từng bất động sản, nhận ra điểm căng thẳng, và ra quyết định mà không phải đoán mò.

Tài chính lúc này không còn chỉ để đối phó với kiểm toán hay thuế. Chúng hướng dẫn thời điểm chi tiêu, lập kế hoạch mở rộng, và quản lý tăng trưởng. Đó là khi việc điều hành bắt đầu cảm thấy có chủ đích, chứ không phải phản ứng liên tục.

### 6.5. Liên hệ với thực tế quản lý dự án tại Việt Nam

Faust tổng kết: *"Khi doanh nghiệp bất động sản phát triển, nó cần nhiều hơn là ghi sổ đơn thuần; cần kiểm soát rõ hơn, báo cáo tốt hơn, tầm nhìn tốt hơn, và hỗ trợ ra quyết định thực chất hơn."*

Phần lớn chủ đầu tư tư nhân quy mô vừa tại Việt Nam đang ở Vùng 2 hoặc Vùng 3. Có hệ thống, nhưng chắp vá. Có số liệu, nhưng tiến độ kỹ thuật và dòng tiền tài chính không nói chuyện được với nhau. Câu hỏi không phải "đang dùng phần mềm gì" mà là "số liệu đó có đang thực sự dẫn dắt quyết định không". Bước chuyển sang Vùng 4 ít khi là vấn đề công nghệ, mà là kỷ luật vận hành: cập nhật nhất quán, tích hợp giữa các bộ phận, và thực sự dùng dữ liệu thay vì chỉ lưu trữ nó.

## 7. Vai trò thực tế của PM trong dự án bất động sản

### 7.1. Trọng tài nội bộ giữa kỹ thuật và kinh doanh
...
## 8. Bài học từ thực tế

### 8.1. Lập kế hoạch đệm có chủ đích
...
### 8.2. Hợp đồng với nhà thầu cần bao gồm điều khoản thị trường
...
### 8.3. Phân tích EVM theo từng tòa nhà
...
Nguyên tắc đơn giản: PV (Planned Value) lấy theo lịch bàn giao từng đợt ghi trong hợp đồng mua bán, EV (Earned Value) theo khối lượng nghiệm thu thực tế, AC (Actual Cost) theo thanh toán thực chi. Cả ba chỉ số này cần cập nhật hàng tháng, không phải hàng quý.
...
Nếu bạn muốn tìm hiểu thêm về các nội dung trong bài viết, liên hệ qua [WhatsApp](https://wa.me/84374874142) hoặc Email: [ha.nguyen@hydrostructai.com](mailto:ha.nguyen@hydrostructai.com).
...
[^1]: Luật Kinh doanh Bất động sản 2023, Điều 23, Thanh toán trong mua bán nhà ở hình thành trong tương lai.
[^2]: Nghị định 175/2024/NĐ-CP, Quy định chi tiết thi hành một số điều của Luật Xây dựng.
[^3]: Tòa án Nhân dân Tối cao (2024), Báo cáo thống kê giải quyết các loại vụ việc dân sự.
[^4]: Goldratt, E.M. (1997), Critical Chain. The North River Press. Áp dụng CCPM trong quản lý dự án xây dựng.
[^5]: Faust, G. (2026), "The 4 Financial Zones of Real Estate Investors". LinkedIn Pulse, ngày 9 tháng 6 năm 2026. Truy cập tại: https://www.linkedin.com/pulse/4-financial-zones-real-estate-investors-gita-faust--mc0oe
...
| 5 | The 4 Financial Zones of Real Estate Investors | Gita Faust, LinkedIn Pulse | 2026 |
