---
# CTA — chèn vào sau phần tài liệu tham khảo, trước dòng copyright cuối file
---
...
HydrostructAI đang sử dụng Calcpad trong quy trình tính toán kỹ thuật nội bộ và có thể chia sẻ template cho một số bài toán phổ biến: dầm đơn, bản sàn phẳng, pile cap.

**Liên hệ:**

- Email: [ha.nguyen@hydrostructai.com](mailto:ha.nguyen@hydrostructai.com) -> ghi rõ loại bài toán và tiêu chuẩn áp dụng
- Liên hệ: [Zalo](https://zalo.me/84374874142) \| [WhatsApp](https://wa.me/84374874142) -> trao đổi kỹ thuật nhanh trong nhóm kỹ sư
